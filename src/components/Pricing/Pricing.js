    ...
    <div className="GlobalContainer">
      <div id="Pricing" className="LPSection">
        <div className="LPSectionBorder">
          <div className="header">Gel Manicures</div>
          <h2>
            The gel manicures are performed on your natural nail with a
            waterless manicure. It includes nail shaping and Russian Cuticle
            Care. If you're preference is to just push back the cuticle, please
            let me know. Products used are from{" "}
            <a href="https://kokoistusa.com/pages/what-is-japanese-gel">
              Kokoist
            </a>
            , a japanese brand that is vegan, and 9-free non toxic. Extensions
            are an add on option for $20.
          </h2>
          <div id="TableHeaders" class="flex-container">
            <div>Tiers</div>
            <div>Starting Price</div>
            <div>Description</div>
          </div>
          <div id="firstRow" class="flex-container">
